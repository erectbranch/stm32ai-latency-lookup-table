...
from marshmallow import Schema, fields, post_dump    # marshmallow==3.20.1
...
# 240910 이후
# https://github.com/STMicroelectronics/stm32ai-modelzoo/blob/1469a5b01627de68b6be309a2a934388015fa459/common/stm32ai_dc/types.py#L1068
class CliParameters(typing.NamedTuple):
    """
        Define the parameters that can be sent to the underlying command line call
    """
